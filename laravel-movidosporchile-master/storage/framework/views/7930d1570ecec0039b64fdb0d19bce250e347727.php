...
<html lang="en">
<head>
  <link rel="shortcut icon" type="image/x-icon" href="<?php echo e(URL::asset('imagenes/icono.png')); ?>">
  <meta charset="utf-8">
  ...
  <?php echo e(Html::style('css/octicons.css')); ?>


  <!-- Custom styles for specific pages -->
  <?php echo $__env->yieldContent('style'); ?>
  <?php echo $__env->yieldContent('style2'); ?>
  <?php echo $__env->yieldContent('style3'); ?>
</head>

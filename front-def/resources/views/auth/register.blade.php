        ...
        <div class="panel-body">
          <form class="form-horizontal" method="POST" action="{{ route('register') }}">
            ...
            <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
              ...
              <input id="email" type="email" class="form-control" placeholder="pymeval@pym.cl" name="email" value="{{ old('email') }}" required>
            ...
            <div class="form-row">
              <div class="col-md-8">
                <div class="form-group{{ $errors->has('username') ? ' has-error' : '' }}">
                  <label for="username" class="control-label">Nombre Micro Empresa</label>
            ...
            <div class="form-group">
              <button type="submit" class="btn btn-primary" style="background-color: #002633; border: 5px solid #002633">Registrarse</button>
            </div>
          </form>
        </div>
      </div>

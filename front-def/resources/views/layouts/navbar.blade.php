...
<header>
  ...
  <nav class="navbar navbar-expand-md fixed-top bg-white navbar-light"  >
    ...
    <a class="navbar-brand logo" href="/">
      <img src="{{ URL::asset('imagenes/logo.png') }}"  height="40" alt="PymeVal">
    </a>
    ...
    <div class="collapse navbar-collapse nav-pills nav-fill">
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item {{ Request::segment(1) === 'microempresa' ? 'active' : null }}">
          <a class="nav-link" href="{{ url('microempresa') }}">Microempresas</a>
        </li>
      </ul>
      <ul class="navbar-nav">
